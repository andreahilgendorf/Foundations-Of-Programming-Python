...
# Description: A class for managing the file processor
...
class FileProcessor:
    ...
    ChangeLog: (Who, When, What)
    AHilgendorf,09/25/2024,Created Class
    """
    ...
    def read_employee_data_from_file(file_name: str, employee_data: list, employee_type: Employee):
        ...
        ChangeLog: (Who, When, What)
        AHilgendorf, 09/25/2024,Created function
...
if __name__ == '__main__':
    print("This file is to hold related classes, please run main.py")